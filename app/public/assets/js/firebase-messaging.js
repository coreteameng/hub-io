    ...
    try {
        (function () {
            ...
            var s = "FirebaseError",
                ...
                c = function () {
                    return function (e, t) {
                        if (this.code = e, this.message = t, a) a(this, u.prototype.create);
                        else try {
                            throw Error.apply(this, arguments)
                        } catch (e) {
                            this.name = s, Object.defineProperty(this, "stack", {
                                get: function () {
                                    return e.stack
                                }
                            })
            ...
            c.prototype = Object.create(Error.prototype), c.prototype.constructor = c, c.prototype.name = s;
            var u = function () {
                function e(e, t, n) {
            ...
            ! function (e) {
                ...
                n(t, e), t.prototype.reset = function () {
            ...
            var f = function () {
                ...
                return e.prototype.next = function (e) {
                    ...
                    void 0 === (r = function (e, t) {
                        ...
                        error: t,
                        complete: n
                    }).next && (r.next = d), void 0 === r.error && (r.error = d), void 0 === r.complete && (r.complete = d);
                ...
                return e.prototype.getToken = function (e, t, n) {
                    return i(this, void 0, void 0, function () {
                        ...
                        return o(this, function (o) {
                            switch (o.label) {
                                case 0:
                                    r = y(t.getKey("p256dh")), i = y(t.getKey("auth")), s = "authorized_entity=" + e + "&endpoint=" + t.endpoint + "&encryption_key=" + r + "&encryption_auth=" + i, S(n.buffer, g.buffer) || (a = y(n), s += "&application_pub_key=" + a), (c = new Headers).append("Content-Type", "application/x-www-form-urlencoded"), u = {
                                        method: "POST",
                                        headers: c,
                                        body: s
                                    }, o.label = 1;
                                case 1:
                                    return o.trys.push([1, 4, , 5]), [4, fetch(T + "/fcm/connect/subscribe", u)];
                                case 2:
                                    return [4, o.sent().json()];
                                case 3:
                                    return h = o.sent(), [3, 5];
                                case 4:
                                    throw o.sent(), v.create(E.TOKEN_SUBSCRIBE_FAILED);
                                case 5:
                                    if (h.error) throw f = h.error.message, v.create(E.TOKEN_SUBSCRIBE_FAILED, {
                                        message: f
                                    });
                                    if (!h.token) throw v.create(E.TOKEN_SUBSCRIBE_NO_TOKEN);
                                    if (!h.pushSet) throw v.create(E.TOKEN_SUBSCRIBE_NO_PUSH_SET);
                                    return [2, {
                                        token: h.token,
                                        pushSet: h.pushSet
                                    }]
                    ...
                    return i(this, void 0, void 0, function () {
                        ...
                        return o(this, function (o) {
                            switch (o.label) {
                                case 0:
                                    i = y(r.getKey("p256dh")), a = y(r.getKey("auth")), c = "push_set=" + n + "&token=" + t + "&authorized_entity=" + e + "&endpoint=" + r.endpoint + "&encryption_key=" + i + "&encryption_auth=" + a, S(s.buffer, g.buffer) || (u = y(s), c += "&application_pub_key=" + u), (h = new Headers).append("Content-Type", "application/x-www-form-urlencoded"), f = {
                                        method: "POST",
                                        headers: h,
                                        body: c
                                    }, o.label = 1;
                                case 1:
                                    return o.trys.push([1, 4, , 5]), [4, fetch(T + "/fcm/connect/subscribe", f)];
                                case 2:
                                    return [4, o.sent().json()];
                                case 3:
                                    return d = o.sent(), [3, 5];
                                case 4:
                                    throw o.sent(), v.create(E.TOKEN_UPDATE_FAILED);
                                case 5:
                                    if (d.error) throw p = d.error.message, v.create(E.TOKEN_UPDATE_FAILED, {
                                        message: p
                                    });
                                    if (!d.token) throw v.create(E.TOKEN_UPDATE_NO_TOKEN);
                                    return [2, d.token]
                            }
                        })
                    })
                    ...
                    return i(this, void 0, void 0, function () {
                        ...
                        return o(this, function (o) {
                            switch (o.label) {
                                case 0:
                                    r = "authorized_entity=" + e + "&token=" + t + "&pushSet=" + n, (i = new Headers).append("Content-Type", "application/x-www-form-urlencoded"), s = {
                                        method: "POST",
                                        headers: i,
                                        body: r
                                    }, o.label = 1;
                                case 1:
                                    return o.trys.push([1, 4, , 5]), [4, fetch(T + "/fcm/connect/unsubscribe", s)];
                                case 2:
                                    return [4, o.sent().json()];
                                case 3:
                                    if ((a = o.sent()).error) throw c = a.error.message, v.create(E.TOKEN_UNSUBSCRIBE_FAILED, {
                                        message: c
                                    });
                                    return [3, 5];
                                case 4:
                                    throw o.sent(), v.create(E.TOKEN_UNSUBSCRIBE_FAILED);
                                case 5:
                                    return [2]
                            }
                        })
                    ...
                    ! function (e) {
                        if (e.objectStoreNames.contains(N)) {
                            ...
                            r.onerror = function (e) {
                                ...
                                } else e.close(), indexedDB.deleteDatabase(D)
                            }
                        }
                    }(e.result)
                }
            ...
            var O = function () {
                ...
                return e.prototype.get = function (e) {
                    ...
                    return void 0 === t && (t = "readonly"), i(this, void 0, void 0, function () {
                        var n, r, i, s;
                        return o(this, function (o) {
                            switch (o.label) {
                                case 0:
                                    return [4, this.getDb()];
                                case 1:
                                    return n = o.sent(), r = n.transaction(this.objectStoreName, t), i = r.objectStore(this.objectStoreName), [4, function (e) {
                                ...
                                case 2:
                                    return s = o.sent(), [2, new Promise(function (e, t) {
            ...
            var k = function (e) {
                ...
                return n(t, e), t.prototype.onDbUpgrade = function (e, t) {
                    var n = e.result;
                    switch (t.oldVersion) {
                        case 0:
                        ...
                        case 2:
                            ...
                            o.onsuccess = function () {
                                ...
                                if (e) {
                                    var t = e.value,
                                        n = r({}, t);
                                    t.createTime || (n.createTime = Date.now()), "string" == typeof t.vapidKey && (n.vapidKey = I(t.vapidKey)), "string" == typeof t.auth && (n.auth = I(t.auth).buffer), "string" == typeof t.auth && (n.p256dh = I(t.p256dh).buffer), e.update(n), e.continue()
                                }
                            }
                    }
                    ...
                    return i(this, void 0, void 0, function () {
                        return o(this, function (t) {
                            if (!e) throw v.create(E.BAD_TOKEN);
                            return A({
                                fcmToken: e
                    ...
                    return i(this, void 0, void 0, function () {
                        return o(this, function (t) {
                            if (!e) throw v.create(E.BAD_SCOPE);
                            return A({
                                swScope: e
                            }), [2, this.get(e)]
                        })
                    ...
                    return i(this, void 0, void 0, function () {
                        return o(this, function (t) {
                            if (!e.swScope) throw v.create(E.BAD_SCOPE);
                            if (!e.vapidKey) throw v.create(E.BAD_VAPID_KEY);
                            if (!e.endpoint || !e.auth || !e.p256dh) throw v.create(E.BAD_SUBSCRIPTION);
                            if (!e.fcmSenderId) throw v.create(E.BAD_SENDER_ID);
                            if (!e.fcmToken) throw v.create(E.BAD_TOKEN);
                            if (!e.fcmPushSet) throw v.create(E.BAD_PUSH_SET);
                            return A(e), [2, this.put(e)]
                        })
                    })
                    ...
                    return i(this, void 0, void 0, function () {
                        ...
                        return o(this, function (n) {
                            switch (n.label) {
                                ...
                                case 1:
                                    if (!(t = n.sent())) throw v.create(E.DELETE_TOKEN_NOT_FOUND);
            ...
            function A(e) {
                if (e.fcmToken && ("string" != typeof e.fcmToken || 0 === e.fcmToken.length)) throw v.create(E.BAD_TOKEN);
                if (e.swScope && ("string" != typeof e.swScope || 0 === e.swScope.length)) throw v.create(E.BAD_SCOPE);
                if (e.vapidKey && (!(e.vapidKey instanceof Uint8Array) || 65 !== e.vapidKey.length)) throw v.create(E.BAD_VAPID_KEY);
                if (e.endpoint && ("string" != typeof e.endpoint || 0 === e.endpoint.length)) throw v.create(E.BAD_SUBSCRIPTION);
                if (e.auth && !(e.auth instanceof ArrayBuffer)) throw v.create(E.BAD_SUBSCRIPTION);
                if (e.p256dh && !(e.p256dh instanceof ArrayBuffer)) throw v.create(E.BAD_SUBSCRIPTION);
                if (e.fcmSenderId && ("string" != typeof e.fcmSenderId || 0 === e.fcmSenderId.length)) throw v.create(E.BAD_SENDER_ID);
                if (e.fcmPushSet && ("string" != typeof e.fcmPushSet || 0 === e.fcmPushSet.length)) throw v.create(E.BAD_PUSH_SET)
            }
            var P = function (e) {
                    function t() {
                        var t = null !== e && e.apply(this, arguments) || this;
                    ...
                    return n(t, e), t.prototype.onDbUpgrade = function (e) {
                        ...
                        return i(this, void 0, void 0, function () {
                            ...
                            return o(this, function (n) {
                                switch (n.label) {
                                    case 0:
                                        if ("string" != typeof e || 0 === e.length) throw v.create(E.BAD_SCOPE);
                                        return [4, this.get(e)];
                                    case 1:
                        ...
                        return i(this, void 0, void 0, function () {
                            ...
                            return o(this, function (r) {
                                if ("string" != typeof e || 0 === e.length) throw v.create(E.BAD_SCOPE);
                                if (null === t || 65 !== t.length) throw v.create(E.BAD_VAPID_KEY);
                                return n = {
                                    swScope: e,
                                    vapidKey: t
                                }, [2, this.put(n)]
                        ...
                        return i(this, void 0, void 0, function () {
                            ...
                            return o(this, function (n) {
                                switch (n.label) {
                                    ...
                                    case 1:
                                        if (!(t = n.sent())) throw v.create(E.DELETE_SCOPE_NOT_FOUND);
                ...
                B = function () {
                    function e(e) {
                        var t = this;
                        if (!e.options[C] || "string" != typeof e.options[C]) throw v.create(E.BAD_SENDER_ID);
                        this.messagingSenderId = e.options[C], this.tokenDetailsModel = new k, this.vapidDetailsModel = new P, this.iidModel = new w, this.app = e, this.INTERNAL = {
                            delete: function () {
                                return t.delete()
                            }
                        }
                    ...
                    return e.prototype.getToken = function () {
                        return i(this, void 0, void 0, function () {
                            ...
                            return o(this, function (o) {
                                switch (o.label) {
                                    case 0:
                                        if ("denied" === (e = this.getNotificationPermission_())) throw v.create(E.NOTIFICATIONS_BLOCKED);
                                ...
                                switch (i.label) {
                                    case 0:
                                        return function (e, t, n) {
                                            if (!n.vapidKey || !S(t.buffer, n.vapidKey.buffer)) return !1;
                        ...
                        return i(this, void 0, void 0, function () {
                            ...
                            return o(this, function (o) {
                                switch (o.label) {
                                    case 0:
                                        return o.trys.push([0, 4, , 6]), [4, this.iidModel.updateToken(this.messagingSenderId, r.fcmToken, r.fcmPushSet, t, n)];
                                    case 1:
                                        return i = o.sent(), s = {
                                            swScope: e.scope,
                                            vapidKey: n,
                                    ...
                                    case 3:
                                        return o.sent(), [2, i];
                                    case 4:
                                        return a = o.sent(), [4, this.deleteToken(r.fcmToken)];
                                    case 5:
                                        throw o.sent(), a;
                                    case 6:
                                        return [2]
            ...
            var R = function (e) {
                ...
                return n(t, e), t.prototype.onPush = function (e) {
                    ...
                    return i(this, void 0, void 0, function () {
                        ...
                        return o(this, function (o) {
                            switch (o.label) {
                                ...
                                case 1:
                                    return o.sent() ? [2, this.sendMessageToWindowClients_(t)] : (n = this.getNotificationData_(t)) ? (r = n.title || "", [4, this.getSWRegistration_()]) : [3, 3];
                                case 2:
                                    return i = o.sent(), s = n.actions, a = Notification.maxActions, s && a && s.length > a && console.warn("This browser only supports " + a + " actions.The remaining actions will not be displayed."), [2, i.showNotification(r, n)];
                                case 3:
                        ...
                        return o(this, function (i) {
                            switch (i.label) {
                                ...
                                case 1:
                                    return e = i.sent(), [3, 3];
                                case 2:
                                    throw t = i.sent(), v.create(E.UNABLE_TO_RESUBSCRIBE, {
                                        message: t
                                    });
                                case 3:
                        ...
                        return o(this, function (o) {
                            switch (o.label) {
                                ...
                                case 4:
                                    r = o.sent(), o.label = 5;
                                case 5:
                                    return r ? (delete t.notification, delete t.fcmOptions, i = L(_.NOTIFICATION_CLICKED, t), [2, this.attemptToMessageClient_(r, i)]) : [2]
                            }
                        })
                    })
                    ...
                    if (e && "object" == typeof e.notification) {
                        ...
                        return n.data = r({}, e.notification.data, ((t = {}).FCM_MSG = e, t)), n
                    }
                }, t.prototype.setBackgroundMessageHandler = function (e) {
                    if (!e || "function" != typeof e) throw v.create(E.BG_HANDLER_FUNCTION_EXPECTED);
                    ...
                    return i(this, void 0, void 0, function () {
                        ...
                        return o(this, function (o) {
                            switch (o.label) {
                                case 0:
                                    return t = new URL(e, self.location.href).href, [4, U()];
                                case 1:
                    ...
                    return i(this, void 0, void 0, function () {
                        return o(this, function (n) {
                            if (!e) throw v.create(E.NO_WINDOW_CLIENT_TO_MSG);
                        ...
                        return o(this, function (i) {
                            switch (i.label) {
                                case 0:
                                    return [4, U()];
                                case 1:
                                    return t = i.sent(), n = L(_.PUSH_MSG_RECEIVED, e), [4, Promise.all(t.map(function (e) {
                    ...
                    return i(this, void 0, void 0, function () {
                        ...
                        return o(this, function (n) {
                            switch (n.label) {
                                ...
                                case 1:
                                    if (!(e = n.sent())) throw v.create(E.SW_REGISTRATION_EXPECTED);
            ...
            function L(e, t) {
                return (n = {})[l.TYPE_OF_MSG] = e, n[l.DATA] = t, n;
                var n
            }
            var K, M = function (e) {
                function t(t) {
                    var n = e.call(this, t) || this;
                    return n.registrationToUse = null, n.publicVapidKeyToUse = null, n.manifestCheckPromise = null, n.messageObserver = null, n.tokenRefreshObserver = null, n.onMessageInternal = h(function (e) {
                        n.messageObserver = e
                ...
                return n(t, e), t.prototype.getToken = function () {
                                            ...
                                            return o(this, function (n) {
                                                switch (n.label) {
                                                    ...
                                                    case 5:
                                                        ...
                                                        if ("103953800507" !== t.gcm_sender_id) throw v.create(E.INCORRECT_GCM_SENDER_ID);
                                                        return [2]
                                                }
                                            })
                                        })
                    ...
                    if (!(e instanceof ServiceWorkerRegistration)) throw v.create(E.SW_REGISTRATION_EXPECTED);
                    if (null != this.registrationToUse) throw v.create(E.USE_SW_BEFORE_GET_TOKEN);
                    this.registrationToUse = e
                }, t.prototype.usePublicVapidKey = function (e) {
                    if ("string" != typeof e) throw v.create(E.INVALID_PUBLIC_VAPID_KEY);
                    if (null != this.publicVapidKeyToUse) throw v.create(E.USE_PUBLIC_KEY_BEFORE_GET_TOKEN);
                    var t = I(e);
                    if (65 !== t.length) throw v.create(E.PUBLIC_KEY_DECRYPTION_FAILED);
                    ...
                    return new Promise(function (n, r) {
                        if (t)
                            if ("activated" !== t.state)
                                ...
                                } else r(v.create(E.SW_REG_REDUNDANT));
                        else n(e);
                        else r(v.create(E.NO_SW_IN_REG))
                    })
                }, t.prototype.getSWRegistration_ = function () {
                    var e = this;
            ...
            K = {
                ...
                if (!F()) throw v.create(E.UNSUPPORTED_BROWSER);
